...
<div id="rules_french" class="rules-content <?= $language ?>">
    ...
    <div id="bet_filter">
        ...
        <p class="m-b-0">Un drôle de joueur est présent ! Il s'agit de Robot_Boy. Ses pronos ? Ils sont basés sur ceux de tous les joueurs. Dès que vous créez ou modifiez un prono, il calcule la moyenne des buts pariés par l'ensemble des joueurs et met à jour ses propres pronos. Il reflète donc la tendance des pronostiqueurs !</p>
    </div>
</div>
