...
<?php else : ?>
    ...
    <?php echo form_open('bets/edit/' . $fixture_id);
        ...
        foreach ($fixture_matches as $key => $fixture_match) {
            ...
            echo '<td class="team1_score"><input type="number" name="score_' . $match_id . '_' . $team1_id . '" id="score_' . $match_id . '_' . $team1_id . '" class="score" value="' . $team1_score . '" min="0"' . $disabled . '></td>';
