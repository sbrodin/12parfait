    ...
    <table class="table-bets-edit m-b-2">
        <tbody>
            <tr>
                ...
                <td><input type="text" id="first_name" name="first_name" class="form-control" value="<?= set_value('first_name') ? set_value('first_name') : $user->first_name ; ?>"></td>
            </tr>
            <tr>
                <td><label for="last_name"><?= $this->lang->line('last_name') ?> : </label></td>
                <td><input type="text" id="last_name" name="last_name" class="form-control" value="<?= set_value('last_name') ? set_value('last_name') : $user->last_name ; ?>"></td>
            <tr>
            <tr>
                <td><label for="user_name"><?= $this->lang->line('user_name') ?> : </label></td>
                <td><input type="text" id="user_name" name="user_name" class="form-control" value="<?= set_value('user_name') ? set_value('user_name') : $user->user_name ; ?>"></td>
            <tr>
            <!-- <tr>
