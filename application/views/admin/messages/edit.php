<div class="container">
    ...
    <div class="col-sm-10">
        <a class="btn btn-sm btn-outline-primary m-b-2" href="<?= site_url('onarie/messages')?>"><?= $this->lang->line('back_to_messages_admin') ?></a>

        <?= validation_errors(); ?>

        <?= form_open('onarie/messages/edit/'.$message_id); ?>
