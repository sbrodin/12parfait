...
<?php echo form_open('admin/teams/edit/'.$team->team_id); ?>
    <label for="team_name"><?php echo $this->lang->line('team_name') ?> : </label><input type="text" id="team_name" name="team_name" value="<?php echo $team->name ?>" required="required" autofocus>
