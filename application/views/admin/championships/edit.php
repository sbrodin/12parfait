...
<?php echo form_open('admin/championships/edit/'.$championship->championship_id); ?>
    ...
    <select id="sport" name="sport" required="required">
        <option value="<?php echo strtolower($this->lang->line('football')) ?>" <?php echo ($championship->country==strtolower($this->lang->line('football'))) ? 'selected' : '' ?> ><?php echo $this->lang->line('football') ?></option>
        <option value="<?php echo strtolower($this->lang->line('rugby')) ?>" <?php echo ($championship->country==strtolower($this->lang->line('rugby'))) ? 'selected' : '' ?> ><?php echo $this->lang->line('rugby') ?></option>
    </select>
    <label for="country"><?php echo $this->lang->line('country') ?> : </label>
    <select id="country" name="country" required="required">
        <option value="<?php echo strtolower($this->lang->line('france')) ?>" <?php echo ($championship->country==strtolower($this->lang->line('france'))) ? 'selected' : '' ?> ><?php echo $this->lang->line('france') ?></option>
        <option value="<?php echo strtolower($this->lang->line('europe')) ?>" <?php echo ($championship->country==strtolower($this->lang->line('europe'))) ? 'selected' : '' ?> ><?php echo $this->lang->line('europe') ?></option>
    </select>
    <label for="level"><?php echo $this->lang->line('level') ?> : </label>
    <select id="level" name="level" required="required">
        <option value="1" <?php echo ($championship->level==1) ? 'selected' : '' ?> >1</option>
        <option value="2" <?php echo ($championship->level==2) ? 'selected' : '' ?> >2</option>
    </select>
