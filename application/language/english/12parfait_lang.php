...
$lang['victory_of_home_against'] = 'Victory of %s at home against %s';
$lang['draw_of_home_against'] = 'Nul de %s à domicile contre %s';
$lang['victory_of_out_against'] = 'Victory of %s outside against %s';
$lang['result'] = 'Result';
...
// Scores
$lang['define_username_profile'] = 'If your name is not displayed it means that you have not defined a username. <br/> Go to "<a class="alert-link" href="%s">'.$lang['profile'].' <i class="fa fa-user"></i></a>" (top right corner) to edit that right now !';
$lang['ladder'] = 'Ladder';
$lang['score'] = 'Score';
$lang['scores'] = 'Scores';
